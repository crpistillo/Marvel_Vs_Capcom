...
private:
    ...
    virtual void moveRight(int distance, float vel, Box *boxOfEnemy, bool isGrounded);

    virtual void moveLeft(int distance, float vel, Box *boxOfEnemy, bool isGrounded);
