...
bool Box::isColliding(Box* anotherBox){
	...
	//La proyeccion en x de la caja contacta a la otra caja por el el lado izquierdo
	bool caso1X = ((this->getRightX() > anotherBox->getLeftX()) && (this->getLeftX() < anotherBox->getLeftX()));

	//La proyeccion en x de la caja contacta a la otra caja por el el lado derecho
